...
export const CURRICULUM: PlaygroundData = {
  ...
  "modules": [
    ...
    },
    {
      ...
      "commands_covered": ["SET", "EXPIRE", "TTL", "PERSIST"],
      "steps": [
        {
          "step_id": "2.1",
          "command": "SET <key> <value>",
          "analogy": "Preparing the Message",
          "explanation": "Before we can set a timer, we need a key to work with. Let's create a temporary session ID.",
          "task": "Store '123' in the key 'session_id'.",
          "input_code": "SET session_id 123"
        },
        {
          "step_id": "2.2",
          ...
          "task": "Set 'session_id' to expire in 60 seconds.",
